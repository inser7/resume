...
--
-- Host: localhost
-- Generation Time: May 07, 2014 at 01:26 AM
...
(1, 'en', 'Koltsov Sergey', '', '', 'inser7@ya.ru', '', '', 'PetrSU', '2004-2009', 'Information Systems and Technologies', 'http://petrsu.ru/', 'Russia', 'Resume', '', 'Web developer', 'Find a permanent job in IT ', 'PHP, YiiFramework, CodeIgniter, JS, Python+Django, Linux, SQL, HTML, CSS,unity3d, experience with servers on linux. I think that the tool is not important. All can be learned for the week. <a href="http://94.140.230.35/deadland/"> unity3d development experience</a>', 1),
(2, 'ru', 'Кольцов Сергей', '', '', 'inser7@ya.ru', '', '', 'ПетрГУ', '2004-2009', 'Информационные системы и технологии', 'http://petrsu.ru/', 'Россия', 'Резюме', '', 'Разработчик', '', 'PHP, YiiFramework, CodeIgniter, JS, Python+Django, Linux, SQL, HTML, CSS,  <a href="http://94.140.230.35/deadland/">опыт разработки на unity3d</a>', 1);
